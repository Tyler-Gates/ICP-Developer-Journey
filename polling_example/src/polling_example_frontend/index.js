...
//Note you will use "polling_example_backend" in this JavaScript code a few times to call the backend
import { polling_example_backend } from "../declarations/polling_example_backend";
...
document.addEventListener('DOMContentLoaded', async (e) => {
  ...
  const question = await polling_example_backend.getQuestion();
  ...
  const voteCounts = await polling_example_backend.getVotes();
...
//via "await polling_example_backend.vote(selectedOption)"
pollForm.addEventListener('submit', async (e) => {
  ...
  const updatedVoteCounts = await polling_example_backend.vote(checkedValue);
...
resetButton.addEventListener('click', async (e) => {
    ...
    await polling_example_backend.resetVotes();
    const voteCounts = await polling_example_backend.getVotes();
    updateLocalVoteCounts(voteCounts);
